  ...
  return (
    <div className="border-t border-rule">
      {projects.map((project, i) => {
        const isOpen = open === i;
        return (
          <article key={project.name} className="border-b border-rule">
            <button
              type="button"
            ...
            >
              <div>
                <div className="grid gap-x-8 gap-y-8 pb-10 md:grid-cols-[4rem_1fr] md:pb-12">
                  ...
                  <div className="grid gap-x-8 gap-y-8 md:grid-cols-12">
                    ...
                    <div className="md:col-span-3 md:justify-self-end">
                      <a
                        ...
                        className="link-rule whitespace-nowrap font-mono text-[11px] uppercase tracking-[0.2em]"
                      >
                        Open repository ↗
                      </a>
                    </div>
